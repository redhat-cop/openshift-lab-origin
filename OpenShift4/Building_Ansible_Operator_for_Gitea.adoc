= Building and publishing a Gitea Operator using the Ansible Operator SDK 1.30
...
[source,sh]
----
export OPERATOR_VERSION=v2.0.0

# No v in front of the Bundle version
export BUNDLE_VERSION=2.0.0

export CATALOG_VERSION=v2.0.0
----
