...
== Ansible Playbook to configure / prepare cluster

The following Ansible Playbook should implement the steps above, thus configure your cluster to be able to recover from a shutdown event. 
